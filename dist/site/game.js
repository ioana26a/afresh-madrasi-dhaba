...
async function boot() {
    ...
    const settings = (0, render_settings_js_1.loadRenderSettings)(displayStorage);
    ...
    scaleControl.onchange = () => { settings.scale = Number(scaleControl.value); renderer.setRenderScale(settings.scale); (0, render_settings_js_1.saveRenderSettings)(displayStorage, settings); };
    statsControl.onchange = () => { settings.stats = statsControl.checked; hud.setEnabled(settings.stats); (0, render_settings_js_1.saveRenderSettings)(displayStorage, settings); };
    const cue = document.querySelector('#batter-cue'), bowl = assets.placement('mcMavu');
    const cueLabel = cue.querySelector('span');
    let batterHintDismissed = false, batterHintStartedMs = null;
    try {
    ...
    const render = (state) => {
        ...
        if (actionable && batterHintStartedMs === null)
            batterHintStartedMs = state.timeMs;
...
},{"./core/game.js":"src/core/game.js","./render/assets.js":"src/render/assets.js","./render/renderer.js":"src/render/renderer.js","./audio/audio.js":"src/audio/audio.js","./input/pointer.js":"src/input/pointer.js","./services/scores.js":"src/services/scores.js","./ui/fullscreen.js":"src/ui/fullscreen.js","./ui/performance-hud.js":"src/ui/performance-hud.js","./ui/render-settings.js":"src/ui/render-settings.js","./render/profile.js":"src/render/profile.js","./services/legacy-scores.js":"src/services/legacy-scores.js","./services/score-configuration.js":"src/services/score-configuration.js","./ui/legacy-score-form.js":"src/ui/legacy-score-form.js","./ui/frame-batch.js":"src/ui/frame-batch.js","./ui/runtime-feedback.js":"src/ui/runtime-feedback.js"}],
...
},{"./assets.js":"src/render/assets.js","./resources.js":"src/render/resources.js"}],
...
function loadRenderSettings(storage) {
    try {
        const saved = JSON.parse(storage?.getItem('madrasi-display') ?? '{}');
...
function saveRenderSettings(storage, settings) {
    try {
        storage?.setItem('madrasi-display', JSON.stringify({ ...settings, version: 2 }));
    }
