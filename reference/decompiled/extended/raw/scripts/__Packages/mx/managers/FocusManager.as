...
while(true)
{
   ...
   else
   {
      if(eval("\x01") == 270)
      {
         ...
         §§pop() extends §§pop() >> (§§pop() | §§pop() << §§pop());
         §§push(§§pop() >>> new §§pop()[§§pop() > §§pop()]());
         break;
      }
      if(eval("\x01") == 714)
      {
      ...
      else
      {
         ...
         if(eval("\x01") == 901)
         {
            ...
            switch(_loc4_)
            {
               case eval("3._{invalid_utf8=151}")["o{invalid_utf8=139}{invalid_utf8=211}"]["\x1f:#?k"][§§constant(22)]:
                  _loc1_ = eval("3._{invalid_utf8=151}")["o{invalid_utf8=139}{invalid_utf8=211}"]["\x1f:#?k"][§§constant(25)][§§constant(8)](_loc3_,eval("3._{invalid_utf8=151}")["o{invalid_utf8=139}{invalid_utf8=211}"]["\x1f:#?k"][§§constant(24)],_loc2_);
                  break;
               case eval("3._{invalid_utf8=151}")["o{invalid_utf8=139}{invalid_utf8=211}"]["\x1f:#?k"][§§constant(23)]:
                  _loc1_ = eval("3._{invalid_utf8=151}")["o{invalid_utf8=139}{invalid_utf8=211}"]["\x1f:#?k"][§§constant(25)][§§constant(8)](_loc3_,eval("3._{invalid_utf8=151}")["o{invalid_utf8=139}{invalid_utf8=211}"]["\x1f:#?k"][§§constant(26)],_loc2_);
            }
            return _loc1_;
         }
         if(eval("\x01") == 518)
            ...
            else
            {
               if(eval("\x01") != 190)
               {
                  if(eval("\x01") == 114)
                  {
                     ...
                     {
                        mx.managers.FocusManager = _loc1_ = function()
                        {
                           super();
                        };
                        ...
                        _loc1_.enableFocusManagement = function()
                        {
                        ...
                        _loc1_.symbolName = "FocusManager";
                        _loc1_.symbolOwner = mx.managers.FocusManager;
                        ...
                        _loc1_.initialized = false;
                        _loc1_.UIObjectExtensionsDependency = mx.core.ext.UIObjectExtensions;
                        §§push((mx.managers.FocusManager.prototype = new mx.core.UIComponent()).addProperty("defaultPushButton",mx.managers.FocusManager.prototype = new mx.core.UIComponent().__get__defaultPushButton,mx.managers.FocusManager.prototype = new mx.core.UIComponent().__set__defaultPushButton));
                        §§push((mx.managers.FocusManager.prototype = new mx.core.UIComponent()).addProperty("nextTabIndex",mx.managers.FocusManager.prototype = new mx.core.UIComponent().__get__nextTabIndex,function()
                        {
                        }
                        ));
